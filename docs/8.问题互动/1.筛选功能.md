...
*src/test/java/com/nofirst/spring/tdd/zhihu/startup/integration/questions/FilterQuestionsTest.java*
...
![](../../images/episode8_2026-03-19_19-14-58.png)

因为我们只是写了接口，却只是为了演示，而返回的空数组。在测试用例里面，我们预期返回分页列表，我们来修改`QuestionController`：
...
![](../../images/episode8_2026-03-19_19-48-00.png)
